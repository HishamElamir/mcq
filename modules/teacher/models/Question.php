...
class Question extends \yii\db\ActiveRecord
{
    ...
    public function getQuestionsByTeacherId(){
        return $this->find()->where(['teacher_id' => \Yii::$app->user->getId()])->all();
    }
    
    public function addQuestion(){
        
         $this->teacher_id = \Yii::$app->user->getId();
        if($this->validate()){

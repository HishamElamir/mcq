...
use app\modules\teacher\models\ExamQuestionSearch;
...
/**
 * ExamQuestionController implements the CRUD actions for ExamsQuestions model.
 */
...
class ExamQuestionController extends Controller
{
    ...
    {    
       ...
       $model->exam_id = $id;
        ...
        $dataProvider = $searchModel->searchExamsForTeacher(Yii::$app->request->queryParams , $id);
    ...
    public function actionCreate($exam_id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new ExamsQuestions",
                ...
                return [
                    ...
                    'title'=> "Create new ExamsQuestions",
                    'content'=>'<span class="text-success">Create ExamsQuestions success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                            Html::a('Create More',['create' , 'exam_id' => $exam_id],['class'=>'btn btn-primary','role'=>'modal-remote'])
    ...
    {
        $request = Yii::$app->request;
        $model = ExamsQuestions::findOne( $id );       
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update ExamsQuestions #".$id,
    ...
    /**
     * Delete an existing ExamsQuestions model.
     * For ajax request will return json object
    ...
    {
        $request = Yii::$app->request;
        ExamsQuestions::findOne($id )->delete();
     ...
     /**
     * Delete multiple existing ExamsQuestions model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed

...
/**
 * MyStudentController implements the CRUD actions for Student model.
 */
...
class StudentController extends Controller
{
    ...
    {
        $model = new \app\Modules\teacher\models\Student();

        
        if ($model->load(Yii::$app->request->post()) && $model->addStudent() != false) {

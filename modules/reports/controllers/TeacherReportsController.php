...
class TeacherReportsController extends Controller {
    ...
    public function actionIndex() {
        ...
        $exams = Exams::find()
                ...
                ->where(['teacher_id' => Yii::$app->user->identity->id])//must be changed to current logged in teacher
                ->orderBy('id')
                ->all();
        ...
        return $this->render('index', array('examswithquestions' => $examswithquestions, 'students' => $students));
    }
